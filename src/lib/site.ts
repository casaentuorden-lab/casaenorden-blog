export const siteConfig = {
  ...
  // Dominio real de despliegue en Cloudflare Workers. Si en el futuro se conecta
  // un dominio propio, actualiza este valor (o la env var NEXT_PUBLIC_SITE_URL).
  url:
    process.env.NEXT_PUBLIC_SITE_URL ||
    "https://casaenorden-blog.casaentuorden.workers.dev",
  locale: "es_ES",
};
